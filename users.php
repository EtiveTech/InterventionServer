<?php
$api_url="http://xxx/c4aAPI/getAllProfiles";
...
<html lang="en" class="no-js">
	...
	<body>
		<div class="container">
			...
			<div class="cbp-mc-column" id="prima_colonna">
	  				</div>
<div class="cbp-mc-column" id="seconda_colonna">
	  				</div>
<div class="cbp-mc-column" id="terza_colonna">
	  				</div>					
